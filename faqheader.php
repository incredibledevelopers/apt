<header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
     ...
     <a href="index.php#hero" class="logo d-flex align-items-center">
        ...
        <span><img src="https://aptsocy.com/public/uploads/media/logo.png" class="logo" alt="Logo"></span>
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="d-none">
            <div class="dropdown">
              <a class="nav-link" href="#" role="button" id="language" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <li><a class="btn" href="https://aptsocy.com/login" alt="sign in">Login</a></li>
          <li><a class="btn" href="https://aptsocy.com/register/client_signup">Register</a></li>
          <li>
