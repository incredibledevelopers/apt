	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				$news_insert = "INSERT INTO tbl_news(newsdate,description,attachment) values('$newsdate','$description','$attachment')";
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				{
				$id = $_GET['id'];
				$fetch_existing_photo_query="SELECT attachment FROM tbl_news where id='$id'";
				...
				while($exiting_photo_row = mysqli_fetch_array($existing_photo_rs)) 
			     {
					...
					$attachment="../news/attachments/".$exiting_photo_row[0];
